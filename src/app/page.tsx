  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 px-6 py-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid items-start gap-8 lg:grid-cols-[420px_1fr] rounded-3xl border border-gray-200 bg-white/80 p-8 shadow-2xl backdrop-blur">
          <div className="space-y-6 rounded-3xl border border-gray-200 bg-white/80 p-6 shadow-xl backdrop-blur lg:sticky lg:top-6">
            {/* FILE UPLOAD */}
            <div>
          ...
          <div className="space-y-6">
            {!review && !loading && (
              <div className="flex min-h-[500px] items-center justify-center rounded-3xl border border-dashed border-gray-300 bg-white/70 p-8 text-center shadow-sm">
                <div>
              ...
              <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-2xl">
                ...
                <div className="mt-6 space-y-4">
                  {review.categories?.map((cat: ReviewCategory, index: number) => (
                    <div key={index} className="rounded-2xl border border-gray-200 bg-gray-50 p-5 shadow-sm transition hover:shadow-md">
                ...
                {review.positionSuggestions && (
                  <div className="mt-6 space-y-4">
                    ...
                    {review.positionSuggestions.map((pos: PositionSuggestion, index: number) => (
                      <div key={index} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md">
